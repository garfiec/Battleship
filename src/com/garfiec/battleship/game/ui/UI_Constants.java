...
public class UI_Constants {
    ...
    // Help boxes
    public static final Dimension HOW_TO_PLAY_SIZE  = new Dimension(700, 350);
    public static final Dimension HOW_TO_USE_SIZE   = new Dimension(700, 500);
    ...
    public static final Color STATUS_BAR_COLOR  = new Color(90, 95, 111);
    public static final Color STATUS_BAR_TEXT_COLOR = new Color(255, 255, 255);
