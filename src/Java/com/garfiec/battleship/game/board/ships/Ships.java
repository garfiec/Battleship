...
public enum Ships {
    AIRCRAFT_CARRIER(Ship_Consts.AIRCRAFT_CARRIER_NAME, Ship_Consts.AIRCRAFT_CARRIER_SIZE, Ship_Consts.BATTLESHIP_QUANTITY),
    BATTLESHIP(Ship_Consts.BATTLESHIP_NAME, Ship_Consts.BATTLESHIP_SIZE, Ship_Consts.BATTLESHIP_QUANTITY),
    DESTORYER(Ship_Consts.DESTORYER_NAME, Ship_Consts.BATTLESHIP_SIZE, Ship_Consts.BATTLESHIP_QUANTITY),
